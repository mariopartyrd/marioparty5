...
void fn_1_7770(s16 arg0, HuVecF* arg1) {
    ...
    scale = 10.0f;
    for (i = 0; i < 8; i++) {
        lbl_1_data_3E8.vel.x =
            scale * (4.0 *
                     sin((3.141592653589793 * (270.0f + (22.5f * i))) /
                         180.0));
        lbl_1_data_3E8.vel.y = 5.0f;
        lbl_1_data_3E8.vel.z =
            scale * (4.0 *
                     cos((3.141592653589793 * (270.0f + (22.5f * i))) /
                         180.0));
    ...
    for (i = 0; i < 8; i++) {
        lbl_1_data_3E8.vel.x =
            scale *
            (2.0 *
             sin((3.141592653589793 * (270.0 + (22.5 + (22.5f * i)))) /
                 180.0));
        lbl_1_data_3E8.vel.y = 5.0f;
        lbl_1_data_3E8.vel.z =
            scale *
            (2.0 *
             cos((3.141592653589793 * (270.0 + (22.5 + (22.5f * i)))) /
                 180.0));
        fn_1_7AE8(arg0, arg1->x, arg1->y * scale, arg1->z, 20.0f * scale, &lbl_1_data_3E8);
    }
}
