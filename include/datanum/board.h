...
enum {
    ...
    BOARD_HSF_sai1 = DATANUM(DATA_board, 24),
    BOARD_HSF_sai2 = DATANUM(DATA_board, 25),
    BOARD_HSF_sai3 = DATANUM(DATA_board, 26),
    BOARD_HSF_sai4 = DATANUM(DATA_board, 27),
    BOARD_HSF_sai5 = DATANUM(DATA_board, 28),
    BOARD_HSF_sai6 = DATANUM(DATA_board, 29),
    ...
    BOARD_ANM_mgVs = DATANUM(DATA_board, 69),
    BOARD_ANM_mg1Vs3 = DATANUM(DATA_board, 70),
    BOARD_ANM_mg2Vs2 = DATANUM(DATA_board, 71),
    BOARD_ANM_mg4P = DATANUM(DATA_board, 72),
    BOARD_ANM_mgKettou = DATANUM(DATA_board, 73),
    BOARD_ANM_mgList = DATANUM(DATA_board, 74),
    BOARD_ANM_mgListCoin = DATANUM(DATA_board, 75),
